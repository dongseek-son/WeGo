...
<head>
    ...
    <script src="/WeGo/daumeditor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
...
<div class="body">
	...
	-->
	<form name="wego_form" id="wego_form" action="#" method="post" accept-charset="utf-8">
		<!-- 에디터 컨테이너 시작 -->
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="/WeGo/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="/WeGo/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="/WeGo/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="/WeGo/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
<!-- 					<div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="/WeGo/daumeditor/images/icon/editor/editor_bi.png" />
		</div>
	</div> -->
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="/WeGo/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<script type="text/javascript">
	var config = {
		...
		form: 'wego_form'+"", /* 등록하기 위한 Form 이름 */
		txIconPath: "/WeGo/daumeditor/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "/WeGo/daumeditor/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
            exitEditor:{
                /*
